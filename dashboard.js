...
(function(){
  ...
  +'<div class="si"><div id="sTI" class="sf"><div class="top">0</div></div><div class="sl">Approved<br>for Intake</div></div>'
  ...
  +'document.getElementById("sTI").innerHTML="<div class=top>"+tiOk+"</div>";'
