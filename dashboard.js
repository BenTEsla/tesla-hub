...
(function(){
  ...
  // Stats bar (Intrepid top)
  +'.sbar{display:flex;align-items:center;padding:0 16px;border-bottom:1px solid #e5e5e5;background:#fff;gap:0}'
  +'.sitem{display:flex;flex-direction:column;align-items:center;padding:10px 18px;cursor:pointer;border-bottom:3px solid transparent;transition:all .15s}'
  +'.sitem:hover{background:#f5f5f5}'
  +'.sitem.on{border-bottom-color:#3e6ae1}'
  +'.snum{font-size:20px;font-weight:700;color:#3e6ae1;line-height:1.2}'
  +'.snum.z{color:#bbb}'
  +'.slbl{font-size:10px;color:#888;white-space:nowrap;margin-top:2px}'
  +'.ssep{width:1px;height:30px;background:#e0e0e0;margin:0 2px}'
  ...
  // === STATS BAR (Intrepid) ===
  +'<div class="sbar">'
  +'<div class="sitem on" onclick="SF(\'all\',this)"><div class="snum" id="sT">-</div><div class="slbl">Livraisons</div></div>'
  +'<div class="ssep"></div>'
  +'<div class="sitem" onclick="SF(\'ok\',this)"><div class="snum" id="sO">-</div><div class="slbl">Pretes</div></div>'
  +'<div class="sitem" onclick="SF(\'al\',this)"><div class="snum" id="sA">-</div><div class="slbl">Alertes</div></div>'
  +'<div class="ssep"></div>'
  +'<div class="sitem"><div class="snum z" id="sP">0</div><div class="slbl">Paiement</div></div>'
  +'<div class="sitem"><div class="snum z" id="sOTG">0</div><div class="slbl">OTG</div></div>'
  +'<div class="sitem"><div class="snum z" id="sPl">0</div><div class="slbl">Plaques</div></div>'
  +'</div>'
