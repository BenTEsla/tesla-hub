...
function startDashboard(){
  ...
  +'#tdh-overlay .tdh-hdr{height:56px !important;background:#fff !important;border-bottom:1px solid #e5e5e5 !important;display:flex !important;align-items:center !important;padding:0 24px !important}'
  ...
  +'#tdh-overlay .tdh-title{padding:28px 24px 12px !important;font-size:32px !important;font-weight:700 !important;color:#171a20 !important;display:block !important;visibility:visible !important}'
  +'#tdh-overlay .tdh-bar{padding:20px 24px !important;display:flex !important;align-items:center !important;gap:8px !important;flex-wrap:wrap !important}'
  +'#tdh-overlay .pi{padding:9px 22px !important;border-radius:20px !important;border:1px solid #d0d0d0 !important;background:#fff !important;cursor:pointer !important;font-size:14px !important;color:#5c5e62 !important;font-family:inherit !important;font-weight:400 !important}'
  ...
  +'#tdh-overlay .bt{padding:9px 22px !important;border-radius:20px !important;border:none !important;font-size:14px !important;font-family:inherit !important;font-weight:500 !important;cursor:pointer !important}'
  ...
  +'#tdh-overlay .tdh-sn{font-size:30px !important;font-weight:300 !important;text-align:center !important;color:#171a20 !important}'
  ...
  +'#tdh-overlay th{padding:14px 16px !important;text-align:left !important;font-size:12px !important;color:#888 !important;font-weight:500 !important;border-bottom:1px solid #e5e5e5 !important;background:transparent !important}'
  +'#tdh-overlay td{padding:18px 16px !important;font-size:15px !important;border-bottom:1px solid #f0f0f0 !important;vertical-align:middle !important;background:transparent !important;color:#393c41 !important}'
  ...
  +'#tdh-overlay .bg{display:inline-block !important;padding:4px 12px !important;border-radius:4px !important;font-size:12px !important;font-weight:600 !important}'
  ...
  +'#tdh-overlay .nm{font-weight:600 !important;cursor:pointer !important;color:#171a20 !important;font-size:15px !important}'
  +'#tdh-overlay .nm:hover{color:#3e6ae1 !important}'
  +'#tdh-overlay .tm{font-size:16px !important;font-weight:500 !important;color:#171a20 !important}'
  +'#tdh-overlay .pl{font-family:SFMono-Regular,Consolas,monospace !important;font-weight:600 !important;font-size:14px !important}'
  ...
  document.getElementById('tdh-load').onclick=async function(){
    ...
    try{
      ...
      var html='';for(var i=0;i<items.length;i++){var d=items[i];html+='<tr class="'+(d.al.length?d.hp?'w':'b':'')+'" data-host="'+d.host+'" data-i="'+i+'"><td><input type="checkbox" class="ck rc" data-i="'+i+'" '+(d.al.length===0?'checked':'')+'/></td><td><span class="tm">'+d.t+'</span></td><td><span class="nm">'+d.name+'</span><br><span style="font-size:11px;color:#aaa">'+d.rn+'</span></td><td><strong>'+d.model+'</strong><br><span style="font-size:12px;color:#888">'+d.color+'</span></td><td>'+(d.hp?'<span class="pl">'+d.plate+'</span>':'<span class="dt dr"></span><span style="color:#dc3545;font-size:12px">Manquante</span>')+'</td><td><span class="bg '+payC(d.pay)+'">'+(d.b2b?'ENTERPRISE':payT(d.pay))+'</span></td><td>'+(d.tims?'<span class="dt dg"></span>'+d.tims:'<span style="color:#ccc">Non</span>')+'</td><td>'+(d.otg?'<span class="dt dg"></span>Oui':'<span class="dt do"></span><span style="font-size:11px;color:#d97706">'+(d.vs||'Non')+'</span>')+'</td><td>'+(d.io?'<span class="dt dg"></span>OK':'<span style="color:#999">Non</span>')+'</td></tr>'}
      tb.innerHTML=html;
