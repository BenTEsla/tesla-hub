...
function startDashboard(){
  ...
  +'#tdh-overlay .H{height:48px !important;background:#fff !important;border-bottom:1px solid #e5e5e5 !important;display:flex !important;align-items:center !important;padding:0 24px !important}'
  +'#tdh-overlay .H .lo{font-size:16px !important;font-weight:600 !important;letter-spacing:3px !important;color:#171a20 !important}'
  +'#tdh-overlay .H .se{margin:0 12px !important;color:#ccc !important}'
  +'#tdh-overlay .H .ap{font-size:14px !important;color:#5c5e62 !important}'
  +'#tdh-overlay .H .ri{margin-left:auto !important;font-size:14px !important;color:#5c5e62 !important}'
  +'#tdh-overlay .T{padding:24px 24px 8px !important;font-size:26px !important;font-weight:600 !important;color:#171a20 !important}'
  +'#tdh-overlay .B{padding:16px 24px !important;display:flex !important;align-items:center !important;gap:8px !important;flex-wrap:wrap !important}'
  ...
  +'#tdh-overlay .SS{margin-left:auto !important;display:flex !important;gap:32px !important}'
  +'#tdh-overlay .SN{font-size:26px !important;font-weight:300 !important;text-align:center !important;color:#171a20 !important}'
  +'#tdh-overlay .SL{font-size:10px !important;text-transform:uppercase !important;letter-spacing:1.5px !important;color:#999 !important;text-align:center !important}'
  +'#tdh-overlay .W{padding:8px 24px 24px !important}'
  ...
  O.innerHTML+=
    '<div class="H"><span class="lo">TESLA</span><span class="se">|</span><span class="ap">Delivery Hub</span><span class="ri">Ben Daubin</span></div>'
  + '<div class="T">Delivery Dashboard</div>'
  + '<div class="B">'
  ...
  + '<div class="SS"><div><div class="SN" id="tdh-sT">-</div><div class="SL">Livraisons</div></div>'
  + '<div><div class="SN" id="tdh-sO">-</div><div class="SL">Pretes</div></div>'
  + '<div><div class="SN" id="tdh-sA">-</div><div class="SL">Alertes</div></div></div>'
  + '</div>'
  + '<div class="W"><div class="ld" id="tdh-ld" style="display:none"><span class="spin"></span> Chargement...</div>'
