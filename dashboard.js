...
(function(){
  ...
  // TITLE Ã¢â‚¬â€ Intrepid exact: 40px, weight 500, padding 20px
  ...
  // TABS Ã¢â‚¬â€ Intrepid exact: grey bg container, toggle style
  ...
  // BUTTONS Ã¢â‚¬â€ Intrepid exact colors
  ...
  // HOST PILLS Ã¢â‚¬â€ Intrepid outline style
  ...
  +'<div class="tabs"><button class="tab on">Customer Delivery</button><button class="tab" onclick="DISPATCH()">Dispatch</button><button class="tab" id="docgenBtn" onclick="LOGINDG()" style="margin-left:auto;font-size:11px">ðŸ”‘ DocGen</button></div>'
  ...
  +'function CHKAUTH(){fetch("http://localhost:3000/api/auth/status").then(function(r){return r.json()}).then(function(j){var b=document.getElementById("docgenBtn");var s=document.getElementById("authStatus");if(j.hasDocgen){b.style.background="#f0fff0";b.style.border="1px solid #28a745";b.style.color="#28a745";b.textContent="âœ… DocGen";s.textContent="DRO âœ… DocGen âœ…"}else{b.style.background="#fff3e0";b.style.border="1px solid #e65100";b.style.color="#e65100";b.textContent="ðŸ”‘ Login DocGen";s.textContent="DRO âœ… DocGen âŒ"}}).catch(function(){})}'
  +'function LOGINDG(){var b=document.getElementById("docgenBtn");b.textContent="â³ Opening...";b.disabled=true;fetch("http://localhost:3000/api/auth/login-docgen").then(function(r){return r.json()}).then(function(j){b.disabled=false;if(j.ok){b.style.background="#f0fff0";b.style.border="1px solid #28a745";b.style.color="#28a745";b.textContent="âœ… DocGen"}else{b.style.color="#c00";b.textContent="âŒ Retry"}}).catch(function(){b.disabled=false;b.textContent="âŒ Retry"})}'
