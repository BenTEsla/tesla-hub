...
(function(){
  ...
  +'<th style="width:70px" id="thDate" class="hid">Date<br><input class="fi" placeholder="..." oninput="CF();event.stopPropagation()" onclick="event.stopPropagation()"></th>'
