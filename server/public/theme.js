...
function applyLight() {
  ...
  s.textContent = ''
    ...
    + '#calModal{background:#fff!important;color:#111827!important}'
    + '#calModal td{border-bottom-color:rgba(0,0,0,.06)!important}'
    + '#calModal th{border-bottom-color:rgba(0,0,0,.1)!important;color:#6b7280!important}'
    + '#calModal input{background:#f9f9f9!important;border-color:rgba(0,0,0,.12)!important;color:#333!important}'
    + 'select,select option{background:#fff!important;border-color:rgba(0,0,0,.12)!important}'
    + 'select:not([style*="color"]){color:#333!important}'
    ...
    + '.nav-item,.nav-group-header{color:#6b7280!important}'
    + '.nav-item:hover,.nav-group-header:hover{color:#171a20!important;background:rgba(0,0,0,.04)!important}'
    ...
    + '#dispatchBalanceBtn:disabled{opacity:.4!important;cursor:not-allowed!important}'
    + '#dispatchSaveBtn{background:rgba(34,197,94,.1)!important;color:#16a34a!important;border-color:rgba(34,197,94,.3)!important}'
    + '#dispatchSaveBtn:disabled{opacity:.4!important;cursor:not-allowed!important}'
    + '#colPickerMenu{background:#fff!important;border-color:rgba(0,0,0,.1)!important;box-shadow:0 8px 24px rgba(0,0,0,.12)!important}'
    + '#notifPanel{background:#fff!important;border-color:rgba(0,0,0,.1)!important;box-shadow:0 8px 24px rgba(0,0,0,.12)!important}'
  ;
  document.head.appendChild(s);
}
