...
(function(){
  ...
  +'.ck{width:18px;height:18px;cursor:pointer}'
  ...
  +'.nm{font-weight:600;color:#171a20;font-size:16px}'
  ...
  +'<th style="cursor:pointer" onclick="S(\'t\')">Heure</th><th style="cursor:pointer" onclick="S(\'name\')">Client</th><th style="cursor:pointer" onclick="S(\'model\')">Vehicule</th><th style="cursor:pointer" onclick="S(\'plate\')">Plaque</th><th style="cursor:pointer" onclick="S(\'pay\')">Paiement</th><th>Trade-In</th><th>OTG</th><th>Assurance</th>'
