...
(function(){
  ...
  +'var tiTotal=DATA.filter(function(d){return d.hasTI}).length;'
  ...
  +'document.getElementById("sTI").innerHTML="<div class=top>"+tiOk+"</div><div class=div>"+tiOk+"</div>";'
