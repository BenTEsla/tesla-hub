...
(function(){
  ...
  +'<div class="ssep"></div>'
  +'<div class="sb">'
  +'<div class="si"><div class="sn k" id="sP">0</div><div class="sl">Payment<br>OK</div></div>'
  +'<div class="si"><div class="sn k" id="sOTG">0</div><div class="sl">OTG</div></div>'
  +'<div class="si"><div class="sn k" id="sPl">0</div><div class="sl">Registration<br>OK</div></div>'
  +'<div class="si"><div class="sn k" id="sTI">0</div><div class="sl">Trade-In</div></div>'
  +'<div class="si"><div class="sn k" id="sAs">0</div><div class="sl">Insurance<br>OK</div></div>'
  +'</div>'
  +'</div>'
  ...
  // PILLS
  +'<div class="pb">'
  +'<span class="pi on" onclick="PF(\'all\',this)">All</span>'
  +CES.map(function(c){return'<span class="pi" onclick="PF(\''+c+'\',this)">'+c.split(' ')[0]+'</span>'}).join('')
  +'</div>'

  // TABLE
  +'<div class="tw"><div class="ld" id="lg" style="display:none"><div class="ldbar"></div><div style="font-size:12px;color:#aaa;margin-top:8px">Loading deliveries...</div></div>'
