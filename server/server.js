...
app.get('/api/tab/arrivals', (req, res) => {
  var html = ''
    ...
    // En Transit card
    + '<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
    + '<div style="font-size:13px;color:#5c5e62;font-weight:500;text-transform:uppercase;letter-spacing:.5px;">En Transit</div>'
    + '<div style="display:flex;align-items:baseline;gap:8px;margin-top:8px;">'
    + '<span id="arrTransit" style="font-size:36px;font-weight:700;color:#3e6ae1;">--</span>'
    + '<span style="font-size:14px;color:#5c5e62;">v\u00e9hicules</span>'
    + '</div>'
    + '<div style="margin-top:12px;height:6px;border-radius:3px;background:#e9ecef;overflow:hidden;">'
    ...
    // Aujourd'hui card
    + '<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
    + '<div style="font-size:13px;color:#5c5e62;font-weight:500;text-transform:uppercase;letter-spacing:.5px;">Aujourd\'hui</div>'
    + '<div style="display:flex;align-items:baseline;gap:8px;margin-top:8px;">'
    + '<span id="arrToday" style="font-size:36px;font-weight:700;color:#28a745;">--</span>'
    + '<span style="font-size:14px;color:#5c5e62;">arriv\u00e9es</span>'
    + '</div>'
    + '<div style="margin-top:10px;font-size:12px;color:#5c5e62;">'
    ...
    // Cette Semaine card
    + '<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
    + '<div style="font-size:13px;color:#5c5e62;font-weight:500;text-transform:uppercase;letter-spacing:.5px;">Cette Semaine</div>'
    + '<div style="display:flex;align-items:baseline;gap:8px;margin-top:8px;">'
    + '<span id="arrWeek" style="font-size:36px;font-weight:700;color:#171a20;">--</span>'
    + '<span style="font-size:14px;color:#5c5e62;">pr\u00e9vues</span>'
    + '</div>'
    + '<div style="margin-top:10px;font-size:12px;color:#28a745;font-weight:600;">'
    ...
    + '<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
    + '<div style="font-size:15px;font-weight:700;color:#171a20;margin-bottom:16px;">D\u00e9tail par Date</div>'
    + '<table style="width:100%;border-collapse:collapse;font-size:14px;">'
    + '<thead>'
    + '<tr style="border-bottom:2px solid #e9ecef;">'
    + '<th style="text-align:left;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;">Date</th>'
    + '<th style="text-align:left;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;">Type</th>'
    + '<th style="text-align:center;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;">Count</th>'
    + '<th style="text-align:center;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;"></th>'
    + '<th style="text-align:center;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;"></th>'
    + '</tr>'
    + '</thead>'
    + '<tbody id="arrVehicleBody">'
    + '<tr><td colspan="5" style="padding:40px;text-align:center;color:#999;">Loading...</td></tr>'
    + '</tbody>'
    + '</table>'
    + '</div>'
    + '</div>';
