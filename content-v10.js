...
(function(){
  ...
  // TITLE
  +'<div class="title-row"><h1 id="pageTitle" class="ttl">Customer Delivery</h1><div style="flex:1"></div><div id="tabActions"></div><div id="themeAnchor" style="margin-left:12px"></div></div>'
  ...
  +'function NAV(idx,el){document.querySelectorAll(".nav-item").forEach(function(n){n.classList.remove("on")});el.classList.add("on");var titles=["Customer Delivery","Arrivals","Stock","Trade-In","CSAT"];var pt=document.getElementById("pageTitle");if(pt)pt.textContent=titles[idx]||"";var ta=document.getElementById("tabActions");if(ta){var acts=["","<a href=\\"https://bi.teslamotors.com/#/views/EMEA-ETA2SC/VehicleArrival\\" target=\\"_blank\\" class=\\"bt bt-p\\">BI Export</a>","","<button onclick=\\"ENRICHTI()\\" class=\\"bt\\" style=\\"background:rgba(245,158,11,.15);color:#f59e0b;border-color:rgba(245,158,11,.3)\\">Enrich</button><button onclick=\\"TRIGGERSCAN(this)\\" class=\\"bt\\" style=\\"background:rgba(168,85,247,.15);color:#a855f7;border-color:rgba(168,85,247,.3)\\">Scan</button><a href=\\"/scan.html\\" target=\\"_blank\\" class=\\"bt bt-p\\">Upload</a>",""];ta.innerHTML=acts[idx]||"";ta.style.display=acts[idx]?"flex":"none";ta.style.gap="8px"}STAB(idx,null)}'
