...
(function(){
  ...
  +'.si{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:18px 16px;cursor:pointer;transition:all .12s;position:relative;min-width:110px}'
