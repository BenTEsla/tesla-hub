...
(function(){
  ...
  +'<button class="bt" style=\"background:#28a745;color:#fff;border:none\" onclick="G()">Print</button><button class="bt" style="background:#3e6ae1;color:#fff;border:none;margin-left:4px" onclick="GPDG()">PDG</button>'
