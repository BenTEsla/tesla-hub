...
(function(){
  ...
  +'<td><input class="fi" placeholder="..." oninput="CF()"></td>'
  +'<td><input class="fi" placeholder="..." oninput="CF()"></td>'
  +'<td><input class="fi" placeholder="..." oninput="CF()"></td>'
  +'<td><select class="fi" onchange="CF()"><option value="">Tous</option><option value="Model 3">Model 3</option><option value="Model Y">Model Y</option></select></td>'
  +'<td><input class="fi" placeholder="..." oninput="CF()"></td>'
  +'<td><select class="fi" onchange="CF()"><option value="">Tous</option><option value="OK">OK</option><option value="Non">Non</option></select></td>'
  +'<td><select class="fi" onchange="CF()"><option value="">Tous</option><option value="Accepted">Oui</option><option value="Non">Non</option></select></td>'
  +'<td><select class="fi" onchange="CF()"><option value="">Tous</option><option value="Oui">Oui</option></select></td>'
  +'<td><select class="fi" onchange="CF()"><option value="">Tous</option><option value="OK">OK</option><option value="Non">Non</option></select></td>'
