...
(function(){
  ...
  // Auto-detect server URL (localhost or network IP)
  var SERVER='http://'+location.hostname+':3000';
  if(location.hostname==='dro.tesla.com')SERVER='http://localhost:3000';
  fetch(SERVER+'/api/auth/status').catch(function(){SERVER='http://10.86.17.25:3000'});
