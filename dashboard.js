...
(function(){
  ...
  +'.ttl{padding:32px 32px 12px;font-size:28px;font-weight:500;color:#171a20;font-family:USD,UST,sans-serif}'
  ...
  +'.stat-click{cursor:pointer;padding:12px 20px;border-right:1px solid #e5e5e5;text-align:center;min-width:80px;transition:background .15s}'
  +'.stat-click:last-child{border-right:none}'
  +'.stat-click:hover{background:#f5f5f5}'
  +'.sn{font-size:28px;font-weight:300;text-align:center;color:#171a20}'
