...
function RW() {
  ...
  for (var i = 0; i < DATA.length; i++) {
    ...
    out += '<tr class="' + (d.al.length ? "w" : "") + '" data-host="' + d.host + '">'
      ...
      + '<td data-col="customer"><span class="nm">' + d.name + '</span>' + (d.used ? ' <span style="font-size:9px;background:rgba(249,115,22,.15);color:#f97316;padding:1px 5px;border-radius:8px;font-weight:600;vertical-align:middle">USED</span>' : '') + '</td>'
