...
(function(){
  ...
  +'function UV(){var cotg=0,fg=0,del=0;DATA.forEach(function(d){if(d.vs==="Arrived at VRL")cotg++;if(d.vs==="Finished Goods"||d.vs==="Deliverable/PDI Complete")fg++;if(d.delivered)del++});document.getElementById("sCotg").textContent=cotg;document.getElementById("sFg").textContent=fg;document.getElementById("sDel").textContent=del}'
