...
(function(){
  ...
  +'</scr'+'ipt>'
  +'</div>' // close mainView
  +'<div id="csatView" style="display:none">' 
+'<div id="tabCsat" style="padding:24px;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;color:#171a20;">'
...
+'<span id="csatScore" style="font-size:36px;font-weight:700;color:#171a20;">4.2</span>'
+'<span style="font-size:16px;color:#5c5e62;font-weight:500;">/5</span>'
+'</div>'
+'<div id="csatScoreBar" style="margin-top:12px;height:6px;border-radius:3px;background:#e9ecef;overflow:hidden;">'
+'<div style="width:84%;height:100%;border-radius:3px;background:#28a745;"></div>'
+'</div>'
+'</div>'
+'<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
+'<div style="font-size:13px;color:#5c5e62;font-weight:500;text-transform:uppercase;letter-spacing:.5px;">NPS</div>'
+'<div style="display:flex;align-items:baseline;gap:8px;margin-top:8px;">'
+'<span id="csatNps" style="font-size:36px;font-weight:700;color:#3e6ae1;">72</span>'
+'</div>'
+'<div style="margin-top:10px;font-size:12px;color:#28a745;font-weight:600;">'
+'<span id="csatNpsTrend">&#9650; +5 vs mois dernier</span>'
+'</div>'
+'</div>'
+'<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
+'<div style="font-size:13px;color:#5c5e62;font-weight:500;text-transform:uppercase;letter-spacing:.5px;">Surveys</div>'
+'<div style="margin-top:8px;">'
+'<span id="csatSurveys" style="font-size:36px;font-weight:700;color:#171a20;">156</span>'
+'</div>'
+'<div style="margin-top:10px;font-size:12px;color:#5c5e62;">'
+'<span id="csatResponseRate">Taux de r\u00e9ponse: <strong>68%</strong></span>'
+'</div>'
+'</div>'
+'<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
...
+'<span id="csatTrendArrow" style="font-size:28px;color:#28a745;">&#9650;</span>'
+'<span id="csatTrendPct" style="font-size:36px;font-weight:700;color:#28a745;">+8%</span>'
+'</div>'
...
+'<table id="csatTableCes" style="width:100%;border-collapse:collapse;font-size:14px;">'
+'<thead>'
...
+'<span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#28a745;margin-right:8px;vertical-align:middle;"></span>'
+'<span id="csatScoreBen" style="font-weight:600;">4.6</span>'
+'</td>'
+'<td id="csatSurveysBen" style="text-align:center;padding:12px;color:#5c5e62;">52</td>'
+'<td style="text-align:center;padding:12px;color:#28a745;font-weight:600;">'
+'<span id="csatTrendBen">&#9650; +0.3</span>'
+'</td>'
+'</tr>'
...
+'<td style="text-align:center;padding:12px;">'
+'<span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#28a745;margin-right:8px;vertical-align:middle;"></span>'
+'<span id="csatScoreSacha" style="font-weight:600;">4.1</span>'
+'</td>'
+'<td id="csatSurveysSacha" style="text-align:center;padding:12px;color:#5c5e62;">58</td>'
+'<td style="text-align:center;padding:12px;color:#f0ad4e;font-weight:600;">'
+'<span id="csatTrendSacha">&#9644; 0.0</span>'
+'</td>'
+'</tr>'
+'<tr style="border-bottom:1px solid #f0f0f0;background:#fff;">'
+'<td style="padding:12px;font-weight:500;">Sophie MACE</td>'
+'<td style="text-align:center;padding:12px;">'
+'<span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#f0ad4e;margin-right:8px;vertical-align:middle;"></span>'
+'<span id="csatScoreSophie" style="font-weight:600;">3.8</span>'
+'</td>'
+'<td id="csatSurveysSophie" style="text-align:center;padding:12px;color:#5c5e62;">46</td>'
+'<td style="text-align:center;padding:12px;color:#dc3545;font-weight:600;">'
+'<span id="csatTrendSophie">&#9660; -0.2</span>'
+'</td>'
+'</tr>'
+'</tbody>'
+'</table>'
...
+'<div style="width:100%;height:70%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#3e6ae1,#5a82e8);min-height:20px;" data-week="1"></div>'
+'<div style="font-size:11px;color:#5c5e62;">S21</div>'
+'</div>'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:12px;font-weight:600;color:#171a20;">4.0</div>'
+'<div style="width:100%;height:75%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#3e6ae1,#5a82e8);min-height:20px;" data-week="2"></div>'
+'<div style="font-size:11px;color:#5c5e62;">S22</div>'
+'</div>'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:12px;font-weight:600;color:#171a20;">4.3</div>'
+'<div style="width:100%;height:86%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#3e6ae1,#5a82e8);min-height:20px;" data-week="3"></div>'
+'<div style="font-size:11px;color:#5c5e62;">S23</div>'
+'</div>'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:12px;font-weight:600;color:#171a20;">4.2</div>'
+'<div style="width:100%;height:84%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#28a745,#34c759);min-height:20px;" data-week="4"></div>'
+'<div style="font-size:11px;color:#5c5e62;">S24</div>'
+'</div>'
+'</div>'
+'</div>' 
+'</div>' +'</div>'
  +'<div id="arrView" style="display:none">' 
+'<div id="tabArrivals" style="padding:24px;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;color:#171a20;">'
...
+'<div style="display:flex;align-items:baseline;gap:8px;margin-top:8px;">'
+'<span id="arrTransit" style="font-size:36px;font-weight:700;color:#3e6ae1;">24</span>'
...
+'<div id="arrTransitBar" style="width:60%;height:100%;border-radius:3px;background:#3e6ae1;"></div>'
+'</div>'
+'</div>'
+'<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
+'<div style="font-size:13px;color:#5c5e62;font-weight:500;text-transform:uppercase;letter-spacing:.5px;">Aujourd\'hui</div>'
+'<div style="display:flex;align-items:baseline;gap:8px;margin-top:8px;">'
+'<span id="arrToday" style="font-size:36px;font-weight:700;color:#28a745;">6</span>'
+'<span style="font-size:14px;color:#5c5e62;">arriv\u00e9es</span>'
+'</div>'
+'<div style="margin-top:10px;font-size:12px;color:#5c5e62;">'
+'<span id="arrTodayDetail">4 livr\u00e9es \u00b7 2 en attente</span>'
+'</div>'
+'</div>'
+'<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
+'<div style="font-size:13px;color:#5c5e62;font-weight:500;text-transform:uppercase;letter-spacing:.5px;">Cette Semaine</div>'
+'<div style="display:flex;align-items:baseline;gap:8px;margin-top:8px;">'
+'<span id="arrWeek" style="font-size:36px;font-weight:700;color:#171a20;">18</span>'
+'<span style="font-size:14px;color:#5c5e62;">pr\u00e9vues</span>'
+'</div>'
+'<div style="margin-top:10px;font-size:12px;color:#28a745;font-weight:600;">'
+'<span id="arrWeekPct">&#9650; +12% vs sem. derni\u00e8re</span>'
+'</div>'
+'</div>'
+'</div>' 
+'<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;margin-bottom:24px;">'
+'<div style="font-size:15px;font-weight:700;color:#171a20;margin-bottom:16px;">Arriv\u00e9es de la Semaine</div>'
+'<div id="arrDailyChart" style="display:flex;align-items:flex-end;gap:10px;height:150px;padding:0 4px;">'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:13px;font-weight:700;color:#171a20;">5</div>'
+'<div style="width:100%;height:62%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#3e6ae1,#5a82e8);min-height:8px;" data-day="lun"></div>'
+'<div style="font-size:12px;color:#5c5e62;font-weight:500;">Lun</div>'
+'</div>'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:13px;font-weight:700;color:#171a20;">3</div>'
+'<div style="width:100%;height:38%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#3e6ae1,#5a82e8);min-height:8px;" data-day="mar"></div>'
+'<div style="font-size:12px;color:#5c5e62;font-weight:500;">Mar</div>'
+'</div>'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:13px;font-weight:700;color:#171a20;">6</div>'
+'<div style="width:100%;height:75%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#28a745,#34c759);min-height:8px;" data-day="mer"></div>'
+'<div style="font-size:12px;color:#5c5e62;font-weight:600;color:#3e6ae1;">Mer</div>'
+'</div>'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:13px;font-weight:700;color:#171a20;">4</div>'
+'<div style="width:100%;height:50%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#3e6ae1,#5a82e8);min-height:8px;" data-day="jeu"></div>'
+'<div style="font-size:12px;color:#5c5e62;font-weight:500;">Jeu</div>'
+'</div>'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:13px;font-weight:700;color:#171a20;">8</div>'
+'<div style="width:100%;height:100%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#3e6ae1,#5a82e8);min-height:8px;" data-day="ven"></div>'
+'<div style="font-size:12px;color:#5c5e62;font-weight:500;">Ven</div>'
+'</div>'
+'<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">'
+'<div style="font-size:13px;font-weight:700;color:#171a20;">2</div>'
+'<div style="width:100%;height:25%;border-radius:6px 6px 0 0;background:linear-gradient(180deg,#3e6ae1,#5a82e8);min-height:8px;" data-day="sam"></div>'
+'<div style="font-size:12px;color:#5c5e62;font-weight:500;">Sam</div>'
+'</div>'
+'</div>'
+'</div>' 
+'<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.06);padding:20px;">'
+'<div style="font-size:15px;font-weight:700;color:#171a20;margin-bottom:16px;">D\u00e9tail V\u00e9hicules</div>'
+'<table id="arrVehicleTable" style="width:100%;border-collapse:collapse;font-size:14px;">'
+'<thead>'
+'<tr style="border-bottom:2px solid #e9ecef;">'
+'<th style="text-align:left;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;">Mod\u00e8le</th>'
+'<th style="text-align:left;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;">VIN (6 dern.)</th>'
+'<th style="text-align:center;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;">ETA</th>'
+'<th style="text-align:left;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;">Origine</th>'
+'<th style="text-align:center;padding:10px 12px;color:#5c5e62;font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.5px;">Statut</th>'
+'</tr>'
+'</thead>'
+'<tbody id="arrVehicleBody">'
+'<tr style="border-bottom:1px solid #f0f0f0;background:#fff;">'
+'<td style="padding:12px;font-weight:500;">Model Y LR</td>'
+'<td style="padding:12px;font-family:monospace;font-size:13px;color:#3e6ae1;">F48K21</td>'
+'<td style="text-align:center;padding:12px;">25 juin</td>'
+'<td style="padding:12px;color:#5c5e62;">Berlin GF</td>'
+'<td style="text-align:center;padding:12px;">'
+'<span style="display:inline-flex;align-items:center;gap:6px;background:#fff3e0;color:#e67e00;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;">'
+'<span style="width:8px;height:8px;border-radius:50%;background:#f0ad4e;"></span>In Transit'
+'</span>'
+'</td>'
+'</tr>'
+'<tr style="border-bottom:1px solid #f0f0f0;background:#fafafa;">'
+'<td style="padding:12px;font-weight:500;">Model 3 SR+</td>'
+'<td style="padding:12px;font-family:monospace;font-size:13px;color:#3e6ae1;">R92M54</td>'
+'<td style="text-align:center;padding:12px;">24 juin</td>'
+'<td style="padding:12px;color:#5c5e62;">Berlin GF</td>'
+'<td style="text-align:center;padding:12px;">'
+'<span style="display:inline-flex;align-items:center;gap:6px;background:#e8f5e9;color:#1b7a2b;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;">'
+'<span style="width:8px;height:8px;border-radius:50%;background:#28a745;"></span>Arrived'
+'</span>'
+'</td>'
+'</tr>'
+'<tr style="border-bottom:1px solid #f0f0f0;background:#fff;">'
+'<td style="padding:12px;font-weight:500;">Model Y Perf</td>'
+'<td style="padding:12px;font-family:monospace;font-size:13px;color:#3e6ae1;">D17N88</td>'
+'<td style="text-align:center;padding:12px;">26 juin</td>'
+'<td style="padding:12px;color:#5c5e62;">Shanghai GF</td>'
+'<td style="text-align:center;padding:12px;">'
+'<span style="display:inline-flex;align-items:center;gap:6px;background:#fff3e0;color:#e67e00;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;">'
+'<span style="width:8px;height:8px;border-radius:50%;background:#f0ad4e;"></span>In Transit'
+'</span>'
...
+'</tr>'
+'<tr style="border-bottom:1px solid #f0f0f0;background:#fafafa;">'
+'<td style="padding:12px;font-weight:500;">Model 3 LR</td>'
+'<td style="padding:12px;font-family:monospace;font-size:13px;color:#3e6ae1;">K63P07</td>'
+'<td style="text-align:center;padding:12px;">23 juin</td>'
+'<td style="padding:12px;color:#5c5e62;">Berlin GF</td>'
+'<td style="text-align:center;padding:12px;">'
+'<span style="display:inline-flex;align-items:center;gap:6px;background:#fde8e8;color:#c62828;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;">'
+'<span style="width:8px;height:8px;border-radius:50%;background:#dc3545;"></span>Delayed'
+'</span>'
+'</td>'
+'</tr>'
+'<tr style="border-bottom:1px solid #f0f0f0;background:#fff;">'
+'<td style="padding:12px;font-weight:500;">Model Y LR</td>'
+'<td style="padding:12px;font-family:monospace;font-size:13px;color:#3e6ae1;">B29W41</td>'
+'<td style="text-align:center;padding:12px;">25 juin</td>'
+'<td style="padding:12px;color:#5c5e62;">Berlin GF</td>'
+'<td style="text-align:center;padding:12px;">'
+'<span style="display:inline-flex;align-items:center;gap:6px;background:#fff3e0;color:#e67e00;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;">'
...
+'<td style="padding:12px;font-weight:500;">Model 3 Perf</td>'
+'<td style="padding:12px;font-family:monospace;font-size:13px;color:#3e6ae1;">A55T19</td>'
+'<td style="text-align:center;padding:12px;">24 juin</td>'
+'<td style="padding:12px;color:#5c5e62;">Berlin GF</td>'
+'<td style="text-align:center;padding:12px;">'
+'<span style="display:inline-flex;align-items:center;gap:6px;background:#e8f5e9;color:#1b7a2b;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;">'
